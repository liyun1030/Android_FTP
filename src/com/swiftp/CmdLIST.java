...
public class CmdLIST extends CmdAbstractListing implements Runnable {
    ...
    public CmdLIST(FtpClientThread sessionThread, String input) {
    ...
    public void run() {
        ...
        mainblock: {
            ...
            LogUtil.d("LIST parameter: " + param);
            while (param.startsWith("-")) {
                // Skip all dashed -args, if present
                LogUtil.d("LIST is skipping dashed arg " + param);
        ...
        if (errString != null) {
            ...
            LogUtil.d("LIST failed with: " + errString);
        } else {
            LogUtil.d("LIST completed OK");
        }
    ...
    protected String makeLsString(File file) {
        ...
        if (!file.exists()) {
            LogUtil.d("makeLsString had nonexistent file");
            return null;
        }
        ...
        if (lastNamePart.contains("*") || lastNamePart.contains("/")) {
            LogUtil.d("Filename omitted due to disallowed character");
            return null;
        } else {
