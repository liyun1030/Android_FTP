...
public class CmdNLST extends CmdAbstractListing implements Runnable {
    ...
    public CmdNLST(FtpClientThread sessionThread, String input) {
    ...
    public void run() {
        ...
        if (errString != null) {
            ...
            LogUtil.d("NLST failed with: " + errString);
        } else {
            LogUtil.d("NLST completed OK");
        }
    ...
    protected String makeLsString(File file) {
        ...
        if (lastNamePart.contains("*") || lastNamePart.contains("/")) {
            ...
            LogUtil.d("Filename: " + lastNamePart);
            return lastNamePart + "\r\n";
        }
    }
}
