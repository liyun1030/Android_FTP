...
public class CmdOPTS extends FtpCmd implements Runnable {
    ...
    public CmdOPTS(FtpClientThread sessionThread, String input) {
    ...
    public void run() {
        ...
        mainBlock: {
            if (param == null) {
                ...
                LogUtil.d("Couldn't understand empty OPTS command");
                break mainBlock;
            }
            String[] splits = param.split(" ");
            if (splits.length != 2) {
                errString = "550 Malformed OPTS command\r\n";
                LogUtil.d("Couldn't parse OPTS command");
                break mainBlock;
            }
            ...
            if (optName.equals("UTF8")) {
                ...
                if (optVal.equals("ON")) {
                    LogUtil.d("Got OPTS UTF8 ON");
                } else {
                    LogUtil.d("Ignoring OPTS UTF8 for something besides ON");
                }
                break mainBlock;
            } else {
                LogUtil.d("Unrecognized OPTS option: " + optName);
        ...
        if (errString != null) {
            ...
            LogUtil.d("Template log message");
        } else {
            sessionThread.writeString("200 OPTS accepted\r\n");
            LogUtil.d("Handled OPTS ok");
        }
    }
