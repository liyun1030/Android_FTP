...
public class NormalDataSocketFactory extends DataSocketFactory {
    ...
    private void clearState() {
        ...
        remoteAddr = null;
        remotePort = 0;
        LogUtil.d("NormalDataSocketFactory state cleared");
    }
    ...
    public int onPasv() {
        ...
        try {
            ...
            LogUtil.d("Data socket pasv() listen successful");
            return server.getLocalPort();
        } catch (IOException e) {
            LogUtil.d("Data socket creation error");
            clearState();
            return 0;
        }
    }
    ...
    public Socket onTransfer() {
        if (server == null) {
            ...
            if (remoteAddr == null || remotePort == 0) {
                LogUtil.d("PORT mode but not initialized correctly");
                clearState();
                return null;
            }
            Socket socket;
            try {
                ...
                LogUtil.d("Couldn't open PORT data socket to: " + remoteAddr.toString() + ":"
                        + remotePort);
                clearState();
                return null;
            }
            ...
            try {
                ...
                LogUtil.d("Couldn't set SO_TIMEOUT");
                clearState();
                return null;
            }
            ...
            try {
                ...
                LogUtil.d("onTransfer pasv accept successful");
            } catch (Exception e) {
                LogUtil.d("Exception accepting PASV socket");
                socket = null;
            }
            clearState();
